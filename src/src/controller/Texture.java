...
public class Texture {
	...
	SpriteSheet bs, ps, bl, ws, js, fs, pu, pats;
	...
	private void getTextures() {
		...
		//PowerUps
		powerup[0] = pu.grabImage(0, 0, 32, 32);//health
		powerup[1] = pu.grabImage(0, 2, 32, 32);//shield
		powerup[2] = pu.grabImage(0, 1, 32, 32);//speed
		// Patroller
