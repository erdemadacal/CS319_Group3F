...
public class Texture {
	...
	SpriteSheet bs, ps, bl, ws, js, fs,pwrs;
	...
	public BufferedImage[] powerup = new BufferedImage[5];
	...
	public Texture() {
		...
		pwrs = new SpriteSheet(powerup_sheet);
	...
	private void getTextures() {
		...
		// Power-ups
		powerup[0] = pwrs.grabImage(0, 0, 32, 32);	// Add Life
		powerup[1] = pwrs.grabImage(0, 1, 32, 32);	// Temporary invulnerabilty
		powerup[2] = pwrs.grabImage(0, 2, 32, 32);	// Full Spectrum Mode
		powerup[3] = pwrs.grabImage(0, 3, 32, 32);	// Increased MoveSpeed
		powerup[4] = pwrs.grabImage(0, 4, 32, 32);	// Increased raed of fire
