	...
	public void loadImageLevel(BufferedImage image) {
		...
		for(int xx = 0; xx < height; xx++) {
			for(int yy = 0; yy < width; yy++) {
				...
				// create powerups
				if(red == 10 && green == 10 && blue == 10) 	// Add life
					addObject(new PowerUp(xx*32, yy*32, ObjectId.Powerup, ColorId.Black, 0));
				if(red == 15 && green == 15 && blue == 15)
					addObject(new PowerUp(xx*32, yy*32, ObjectId.Powerup, ColorId.Black, 1));
				if(red == 20 && green == 20 && blue == 20)
					addObject(new PowerUp(xx*32, yy*32, ObjectId.Powerup, ColorId.Black, 2));
				if(red == 25 && green == 25 && blue == 25)
					addObject(new PowerUp(xx*32, yy*32, ObjectId.Powerup, ColorId.Black, 3));
				if(red == 30 && green == 30 && blue == 30)
					addObject(new PowerUp(xx*32, yy*32, ObjectId.Powerup, ColorId.Black, 4));
